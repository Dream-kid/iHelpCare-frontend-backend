...
export default function EditPatientModal({
  ...
  const [loadingDetails, errorDetails, dataDetails] = useFetchData(
    `/admin/patient/details?id=${editPatientModal?.id}`
  );
  ...
  const handleCloseModal = () => {
    setEditPatientModal((prevState) => ({ ...prevState, open: false, id: null }));
  };
  ...
  const onFinish = (values) => {
    putData('/admin/update/patient', {
      patient_id: editPatientModal?.id,
...
EditPatientModal.propTypes = {
  editPatientModal: PropTypes.func.isRequired,
  setEditPatientModal: PropTypes.func.isRequired,
