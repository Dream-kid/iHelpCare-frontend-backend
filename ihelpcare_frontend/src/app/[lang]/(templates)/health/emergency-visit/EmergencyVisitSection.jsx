...
export default function EmergencyVisitSection({ locale }) {
  return (
    <section className='container mb-5 mt-5 px-5 lg:mt-10 lg:px-0'>
      ...
      <p className='description__anim text-center text-[20px] font-font-normal tracking-wide lg:text-[22px]'>
        Description of Emergency Visit
      </p>
      ...
      >
        ...
        >
          <SharedHomeItemCard
            title='Emergency Medicine Network'
            image={noImage}
            url='https://www.emnet-usa.org/community/findernow-htm'
            target='_blank'
            fullURL
          />
        </Col>
...
EmergencyVisitSection.propTypes = {
